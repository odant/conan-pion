...
class PionConan(ConanFile):
    ...
    def build(self):
        ...
        cmake.definitions["BUILD_ALLOWNOTHINGSERVICE:BOOL"] = "ON"
        cmake.definitions["BUILD_COOKIESERVICE:BOOL"] = "ON"
        cmake.definitions["BUILD_ECHOSERVICE:BOOL"] = "ON"
        cmake.definitions["BUILD_FILESERVICE:BOOL"] = "ON"
        cmake.definitions["BUILD_HELLOSERVICE:BOOL"] = "ON"
        cmake.definitions["BUILD_LOGSERVICE:BOOL"] = "ON"
